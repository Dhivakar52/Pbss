...
export const TopStepWizard: React.FC<TopStepWizardProps> = ({
  ...
  // Step Icons matching the registration sections
              ...
              >
                ...
                <div className="flex items-center w-full">
                  ...
                  <button
                    ...
                    className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center transition-all cursor-pointer shrink-0 shadow-xs z-10 ${
                      isCompleted
                  ...
                  {!isLast && (
                    <div
                      className={`flex-1 h-[2.5px] mx-2.5 sm:mx-3 rounded-full transition-colors duration-300 ${
                        isCompleted
                          ? 'bg-emerald-500'
                ...
                <div className="mt-3.5 space-y-1 text-left">
                  {/* Line 1: Step X */}
                  <span
                    className={`text-[11px] sm:text-xs font-semibold tracking-wider block ${
                      isActive
                  ...
                  <h3
                    onClick={() => onStepSelect(step.id)}
                    className={`text-sm sm:text-base font-bold leading-tight cursor-pointer transition-colors ${
                      isActive
