    ...
    <div className="pbss-print-wrapper bg-white text-black text-[12.5px] leading-snug font-sans">
      ...
      >
        <div className="space-y-4">
          {/* ==========================================
             SECTION 1 - APPLICANT & PARENT BASIC INFO
             ========================================== */}
          <div className="space-y-2 pbss-section-1">
            {/* Top Key Fields */}
            ...
            {/* Siblings Table */}
            <div className="my-2 avoid-break">
          ...
          {/* ==========================================
             SECTION 2 - FATHER & MOTHER DETAILED INFO
             ========================================== */}
          <div className="space-y-2 text-[12px] pt-2 pbss-section-2">
          ...
          {/* ==========================================
             SECTION 3 - GUARDIAN, TRANSPORT, DECLARATION & NOTES
             ========================================== */}
          <div className="space-y-2 text-[11.5px] leading-snug pt-2 pbss-section-3">
            ...
            <div className="pt-1 text-[11.5px] leading-snug avoid-break">
            ...
            {/* Date & Signatures */}
            <div className="pt-1 text-[11.5px] avoid-break">
            ...
            {/* Note Section */}
            <div className="pt-0.5 text-[10.5px] leading-tight space-y-0.5 avoid-break">
