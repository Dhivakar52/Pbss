    ...
    <div className="pbss-print-wrapper bg-white text-black text-[12.5px] leading-snug font-sans">
      ...
      >
        <div className="space-y-4">
          {/* ==========================================
             SECTION 1 - APPLICANT & PARENT DETAILS
             ========================================== */}
          <div className="space-y-3 pbss-section-1">
          ...
          {/* ==========================================
             SECTION 2 - ALUMNUS, DECLARATION & SIGNATURES
             ========================================== */}
          <div className="space-y-3 text-[12px] pt-2 pbss-section-2">
            {/* Alumnus Grid */}
            ...
            <div className="grid grid-cols-12 gap-4 items-start pt-1 avoid-break">
            ...
            {/* Declaration Block */}
            <div className="pt-1 text-[12px] leading-relaxed avoid-break">
            ...
            {/* Signatures Area */}
            <div className="pt-2 text-[12px] avoid-break">
            ...
            <div className="border border-black p-2.5 text-[12px] space-y-1.5 mt-2 bg-white avoid-break">
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-baseline">
          ...
          {/* ==========================================
             ...
             ========================================== */}
          <div className="space-y-2 text-[11.5px] leading-snug pt-2 pbss-section-3 avoid-break">
